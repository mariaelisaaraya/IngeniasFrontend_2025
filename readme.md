...
|-------------|-----------|----------|------------------------------------------------------------------------------------------|-------------------------------------------------------------|
| 31/03/2025  | Lunes     | [Clase 1](https://github.com/mariaelisaaraya/IngeniasFrontend_2025/tree/main/Modulo1/Clase1)  | **Comienzo Módulo 1** Introducción al desarrollo web, HTML básico, estructura y etiquetas                     | Práctica con etiquetas
| 02/04/2025  | ~~Miércoles~~ | -        | Feriado: Día de Malvinas Argentinas 🇦🇷                                               | Sin clase                                              |
| 07/04/2025  | Lunes     | [Clase 2](https://github.com/mariaelisaaraya/IngeniasFrontend_2025/tree/main/Modulo1/Clase2)  | Listas, tablas, formularios, enlaces                                                     |  Sketch del sitio                |
| 09/04/2025  | Miércoles | Clase 3  | Etiquetas multimedia, introducción a CSS, sintaxis, selectores                          | Avanzar con el index del sitio                  |
| 14/04/2025  | Lunes     | [Clase 4](https://github.com/mariaelisaaraya/IngeniasFrontend_2025/tree/main/Modulo1/Clase4)  | CSS Básico: listas, textos, fondos, tipografías, display. Menú de navegación            | Aplicar estilos al index. Maquetar páginas. Armado de Duplas      |
| 16/04/2025  | Miércoles | [Clase 5](https://github.com/mariaelisaaraya/IngeniasFrontend_2025/tree/main/Modulo1/Clase5)  | Box Modeling, propiedades, unidades de medida, display                                   | Incluir propiedades en el proyecto                          |
...
| 02/07/2025  | Miércoles |Clase 26   | Eventos                                                                                   | Se ve Repaso + TPs obligatorios con Li          |
| 07/07/2025  | Lunes     |Clase 27   | Aplicacion Práctica(Pre-Entrega)                                                          | Se ve API 1 y 2, clase 28 y 29                                         |
| 09/07/2025  | ~~Miércoles~~ | -     | Feriado                                                                                   | Sin clase                                       |
| 14/07/2025  | Lunes             |Clase 28   | API   1 y 2                                                                      |🚨 Entrega de la [4ta pre-entrega](https://github.com/mariaelisaaraya/IngeniasFrontend_2025/blob/main/MiniEntrega4.md)      🚨                                                 |
...
No estás sola en este camino. Sumate al Grupo Interno donde compartimos novedades y consultas✨
